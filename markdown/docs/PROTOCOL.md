...
| `Message.CREATE_SERVER`            | 新規 Minecraft サーバーの作成を要求する。                                         | `{ "versionId": string, "serverName"?: string, "serverType"?: "vanilla" \| "forge", "loaderVersion"?: string, "runtime"?: object }`                        | `Message.PROGRESS_UPDATE`, `Message.OPERATION_RESULT`                                 |
